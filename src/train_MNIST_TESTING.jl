...
# function train!(x, opt, ps, y, loss_fn, f, g)
#     batch_loss, back = Flux.pullback(() -> loss_fn(g, f, BATCH_SIZE), ps)
#     grads = back(1)
...
function main()
    ...
    if load_model
        ...
        ps, loss_fn, f, g = create_vae(LATENT_DIM, BATCH_SIZE) |> DEVICE
    end
    ...
    for epoch in 1:epochs
        ...
        while true
            ...
            # batch_loss = train!(images, opt, ps, labels, loss_fn, f, g)
            Flux.train!(loss_fn, ps, images, opt)
