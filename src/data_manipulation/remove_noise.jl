...
@everywhere begin
    ...
    function denoise_image(img::AbstractArray, noise_level::Float64)::AbstractArray
        img_array = float(channelview(img))  # Convert image to 2D array
        img_denoised = bm3d(img_array, noise_level)  # Apply BM3D algorithm
    ...
    function process_file(file::String, noise_level::Float64, base_path::String, base_path_modified::String)
...
function main()
    ...
    #     process_file(file, noise_level, base_path, base_path_modified)
